...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\dissadvisor{Asst.Prof.Dr. Phond Phunchongharn}  % Advisor
%%% Leave it empty if you have no Co-advisor
\def\disscoadvisor{}  % Co-advisor 
\def\disscommitteetwo{Asst.Prof. Pipat Supasirisun}  % 3rd committee member (optional)
\def\disscommitteethree{Assoc.Prof.Dr. Naruemon Wattanapongsakorn}   % 4th committee member (optional) 
...
โรคบกพร่องทางการเรียนรู้เป็นหนึ่งในโรคบกพร่องที่สามารถพบได้ในประเทศไทยรวมถึงอีกหลาย ๆ ประเทศทั่วโลก 
เด็กที่เป็นโรคบกพร่องทางการเรียนรู้นั้นอาจถูกส่งผลให้มีปัญหาในการเรียนรู้ช้า เข้าใจยาก รวมถึงปัญหาพฤติกรรมบางอย่าง
 ถ้าเด็กเป็นโรคบกพร่องทางการเรียนรู้ไม่ได้รับการรักษาอย่างถูกต้อง อาจส่งผลให้เกิดปัญหาอื่นขึ้นตามมา
  โรคบกพร่องทางการเรียนรู้สามารถจำแนกการบกพร่องได้ออกเป็น 3 รูปแบบคือ การบกพร่องด้านการอ่าน 
  การบกพร่องด้านการเขียน และการบกพร่องด้านการแก้ไขปัญหาเชิงคณิตศาสตร์ ในการวินิจฉัยโรคบกพร่องทางการเรียนรู้จำเป็นต้องมีครูชำนาญพิเศษหรือบุคคลที่มีความเชี่ยวชาญเฉพาะทางด้านนี้
   อย่างไรก็ตามบุคคลเหล่านี้มีจำนวนที่ค่อนข้างน้อยทำให้คนไข้หรือเด็กจำเป็นต้องรอเป็นระยะเวลานานพอสมควรก่อนที่จะได้รับการวินิจฉัย และได้รับผลการวินิจฉัยช้าลง
    ในโปรเจ็คนี้ พวกเราขอเสนอแอปพลิเคชันมือถือสำหรับการตรวจจับโรคบกพร่องทางการเรียนรู้ที่มีชื่อว่า “แอลดีสปอต” โดยในโปรเจ็คนี้เราได้มุ่งเน้นไปที่ทักษะด้านการเขียนและสะกดคำของเด็กชั้นประถมศึกษาปีที่ 
     1 ถึงชั้นประถมศึกษาปีที่ 3 โรคบกพร่องทางการเรียนรู้ด้านการเขียนสามารถถูกระบุได้จากการเขียนผิดของสระและตัวอักษรอีกทั้งยังรวมถึงการสะกดคำผิดด้วย และแอปพลิเคชันได้ถูกออกแบบให้เป็นการทำแบบทดสอบที่อยู่ในรูปแบบเกมที่เด็กจำเป็นต้องเขียน สระ พยัญชนะ และคำ โดยอ้างอิงจากเสียงที่เด็กได้ยินระหว่างการทำแบบทดสอบ
      รูปภาพที่เด็กเขียนจะถูกจำแนกให้อยู่ในรูปแบบ เขียนถูกต้อง เขียนผิด และเขียนกลับด้าน ความแม่นยำของโมเดลสำหรับตัวอักษรอยู่ที่ร้อยละ 82 สำหรับสระอยู่ที่ร้อยละ 79.19 
      สำหรับคำสะกดอยู่ที่ร้อยละ 71.05 และผลรับการเขียนทั้งหมดจะถูกสรุปเพื่อให้ผู้เชี่ยวชาญนำไปใช้สำหรับการวินิจฉัยโรคบกพร่องทางการเรียนรู้
\begin{flushleft}
\begin{tabular*}{\textwidth}{@{}lp{0.8\textwidth}}
 & \\
...
\begin{figure}[!ht]\centering
  \setlength{\fboxrule}{0.2mm} % can define this in the preamble
  \setlength{\fboxsep}{1cm}
  \fbox{\includegraphics[width=10cm]{./relu.jpg}}
...
\begin{figure}[!ht]\centering
  \setlength{\fboxrule}{0.2mm} % can define this in the preamble
  \setlength{\fboxsep}{1cm}
  \fbox{\includegraphics[width=7cm]{./blob.jpg}}
...
\begin{figure}[!ht]\centering
  \setlength{\fboxrule}{0.2mm} % can define this in the preamble
  \setlength{\fboxsep}{1cm}
  \fbox{\includegraphics[scale=0.8]{./dyslexia.jpg}}
\end{figure}
...
\begin{figure}[!ht]\centering
    \setlength{\fboxrule}{0.2mm} % can define this in the preamble
    \setlength{\fboxsep}{1cm}
    \fbox{\includegraphics[scale=0.8]{./LDProject - Database Diagram.png}}
...
\newpage
  ...
  \begin{itemize}
    ...
    \begin{figure}[!ht]\centering
     ...
     \begin{figure}[!ht]\centering
      \setlength{\fboxrule}{0.2mm} % can define this in the preamble
      \setlength{\fboxsep}{1cm}
      \fbox{\includegraphics[width=13cm]{./convvowelmodel.png}}
  ...
  \begin{figure}[!ht]\centering
    \setlength{\fboxrule}{0.2mm} % can define this in the preamble
    \setlength{\fboxsep}{1cm}
    \fbox{\includegraphics[width=13cm]{./vowelmodel.png}}
