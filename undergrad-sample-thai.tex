      ...
      \begin{table}[!ht]
        ...
        \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
          ...
          \multicolumn{2}{c}{}&\multicolumn{1}{c}{Specifity}&\multicolumn{1}{c}{Sensitivity}&\multicolumn{1}{c}{Precision}&\multicolumn{1}{c}{F1}\\
            ...
            ก&  0.99 & 0.98 &0.96 & 0.97  \\ \cline{3-6}
            &   ง&0.97 & 0.98 &0.93 & 0.95\\ \cline{3-6}
            &   ฒ&0.99 & 0.94 &0.96 & 0.95 \\ \cline{3-6}
            &   ย&0.99 & 0.92 &0.96 & 0.93  \\ \cline{3-6}
        \end{tabular}
      \end{table}
       \newpage
       ...
       \begin{table}[!ht]
        ...
        \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
          ...
          \multicolumn{2}{c}{}&\multicolumn{1}{c}{-ั}&\multicolumn{1}{c}{-็}&\multicolumn{1}{c}{-๊}&\multicolumn{1}{c}{-์}&\multicolumn{1}{c}{ไ-}\\
            ...
            -ั& 14 & 0 &0 & 0 & 0 \\ \cline{3-7}
            &   -็&0 & 12 &0 & 0 & 0\\ \cline{3-7}
            &   -๊&2 & 1 &26 &0 & 0\\ \cline{3-7}
            &   -์&0 & 0 &0 & 11 & 1 \\ \cline{3-7}
            &   ไ-&0& 0 &0 & 0 & 46\\ \cline{3-7}
        \end{tabular}
      \end{table}
      ...
      \begin{table}[!ht]
        ...
        \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
          ...
          \multicolumn{2}{c}{}&\multicolumn{1}{c}{Specifity}&\multicolumn{1}{c}{Sensitivity}&\multicolumn{1}{c}{Precision}&\multicolumn{1}{c}{F1}\\
            ...
            -ั&0.97 & 1.00 &0.88 & 0.93  \\ \cline{3-6}
            &    -็&0.99 & 1.00 &0.92 & 0.96\\ \cline{3-6}
            &    -๊&1.00 & 0.90 &1.00 & 0.95 \\ \cline{3-6}
            &    -์&1.00 & 0.92 &1.00 & 0.96  \\ \cline{3-6}
            &   ไ-&0.99 & 1.00 &0.98 & 0.99  \\ \cline{3-6}
        \end{tabular}
      \end{table}
        \newpage
        ...
        \begin{table}[!ht]
          ...
          \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
            ...
            \multicolumn{2}{c}{}&\multicolumn{1}{c}{-า}&\multicolumn{1}{c}{-ี}&\multicolumn{1}{c}{-ึ}&\multicolumn{1}{c}{-๋}&\multicolumn{1}{c}{แ-}&\multicolumn{1}{c}{ใ-}\\
              ...
              -า& 40 & 0 &0 & 1 &0 & 1  \\ \cline{3-8}
              &   -ี&0 & 33&1 & 0 &0 & 0\\ \cline{3-8}
              &   -ึ&0 &2 &31 & 0 &0 & 1 \\ \cline{3-8}
              &   -๋&0& 0 &0 & 30 &0 & 0  \\ \cline{3-8}
              &   แ-&0 & 0 &0& 0 &36 & 0 \\ \cline{3-8}
              &   ใ-&0 & 0 &0 & 0 &0 & 35 \\ \cline{3-8}
          \end{tabular}
        \end{table}
        ...
        \begin{table}[!ht]
          ...
          \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
            ...
            \multicolumn{2}{c}{}&\multicolumn{1}{c}{Specifity}&\multicolumn{1}{c}{Sensitivity}&\multicolumn{1}{c}{Precision}&\multicolumn{1}{c}{F1}\\
              ...
              -า&1.00 & 0.95 &1.00 & 0.98  \\ \cline{3-6}
              &   -ี&0.99 & 0.97 &0.94 & 0.96\\ \cline{3-6}
              &   -ึ&0.99 & 0.91 &0.97 & 0.94 \\ \cline{3-6}
              &   -๋&0.99 & 1.00 &0.97 & 0.98  \\ \cline{3-6}
              &   แ-&1.00 & 1.00 &1.00& 1.00 \\ \cline{3-6}
              &   ใ-&0.99 & 1.00 &0.95 & 0.97  \\ \cline{3-6}
          \end{tabular}
        \end{table}
         \newpage
         ...
         \begin{table}[!ht]
          ...
          \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
            ...
            \multicolumn{2}{c}{}&\multicolumn{1}{c}{-ื}&\multicolumn{1}{c}{-ุ}&\multicolumn{1}{c}{-ู}&\multicolumn{1}{c}{-้}&\multicolumn{1}{c}{เ-}\\
              ...
              -ื& 37 & 0 &0 & 0 & 0   \\ \cline{3-7}
              &   -ุ&0 & 37 &0 & 0 & 0 \\ \cline{3-7}
              &   -ู&1 & 1 &31 & 0 & 0  \\ \cline{3-7}
              &   -้&1 & 0 &1 & 27& 0   \\ \cline{3-7}
              &   เ-&2 & 2 &0 & 0 & 38  \\ \cline{3-7}
          \end{tabular}
        \end{table}
        ...
        \begin{table}[!ht]
          ...
          \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
            ...
            \multicolumn{2}{c}{}&\multicolumn{1}{c}{Specifity}&\multicolumn{1}{c}{Sensitivity}&\multicolumn{1}{c}{Precision}&\multicolumn{1}{c}{F1}\\
              ...
              -ื&0.97 & 1.00 &0.90 & 0.95  \\ \cline{3-6}
              &   -ุ&0.98 & 1.00 &0.93 & 0.96\\ \cline{3-6}
              &   -ู&0.99 & 0.94 &0.97 & 0.95 \\ \cline{3-6}
              &   -้&1.00 & 0.93 &1.00 & 0.96  \\ \cline{3-6}
              &   เ-&1.00 & 0.90 &1.00 & 0.95  \\ \cline{3-6}
          \end{tabular}
        \end{table}
          \newpage
          ...
          \begin{table}[!ht]
            ...
            \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
              ...
              \multicolumn{2}{c}{}&\multicolumn{1}{c}{-ะ}&\multicolumn{1}{c}{-ำ}&\multicolumn{1}{c}{-ิ}&\multicolumn{1}{c}{-่}&\multicolumn{1}{c}{โ-}\\
                ...
                -ะ& 39 & 0 &0 & 0 & 1   \\ \cline{3-7}
                &   -ำ&0 & 23 &1 & 0 & 1 \\ \cline{3-7}
                &   -ิ&1 & 0 &37 & 0 & 0\\ \cline{3-7}
                &   -่&0 & 0 &0 & 38  & 0 \\ \cline{3-7}
                &   โ-&0 & 0 &0 & 1 & 29   \\ \cline{3-7}          
            \end{tabular}
          \end{table}
          ...
          \begin{table}[!ht]
            ...
            \begin{tabular}{ll|P{2cm}|P{2cm}|P{2cm}|P{2cm}|}
              ...
              \multicolumn{2}{c}{}&\multicolumn{1}{c}{Specifity}&\multicolumn{1}{c}{Sensitivity}&\multicolumn{1}{c}{Precision}&\multicolumn{1}{c}{F1}\\
                ...
                -ะ&0.99 & 0.97 &0.97 & 0.97  \\ \cline{3-6}
                &   -ำ&1.00 & 0.92 &1.00 & 0.96\\ \cline{3-6}
                &   -ิ&0.99 & 0.97 &0.97 & 0.97 \\ \cline{3-6}
                &   -่&0.99 & 1.00 &0.97 & 0.99  \\ \cline{3-6}
                &   โ-&0.99 & 0.97 &0.94 & 0.95  \\ \cline{3-6}
            \end{tabular}
          \end{table}
          \newpage
